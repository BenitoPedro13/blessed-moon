# Handoff: Blessed Moon Studio — Website (ASCII/TUI direction)
...
### 2. Work — case studies (`work-1d.png`)
...
## Files
- `Blessed Moon — Website Wireframes.dc.html` — full wireframe file (all explored options; homepage direction **1c**, subpages **1d/1e/1f** are the ones selected for this handoff — other lettered options in the file are earlier alternatives, ignore them)
- `screenshots/homepage-1c.png`, `work-1d.png`, `about-1e.png`, `contact-1f.png` — static captures of the selected screens
...
Note: this is a **wireframe/handoff repo**, not the implementation. There is no app code here yet — see `CLAUDE.md` for the working-process rules once the Next.js build starts.
